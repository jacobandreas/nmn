...
\begin{abstract}
  ...
  instead varies depending on the question. At the same time, the task is
  ...
  dog?} and \emph{where is the cat?}. We wish to simultaneously exploit the
  representational capacity of deep networks and the dynamic compositional
  structure of questions. XXX
  In this paper, we describe a procedure for constructing and learning
...
supposed to be a cat detector, and \mod{combine[and]} doesn't know it's supposed
